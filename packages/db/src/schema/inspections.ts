...
export const checklistTemplates = pgTable(
  ...
  (table) => [index("checklist_templates_project_id_idx").on(table.projectId)],
);
...
export const checklistTemplateItems = pgTable(
  ...
  (table) => [index("checklist_template_items_template_id_idx").on(table.templateId)],
);
...
export const inspections = pgTable(
  ...
  (table) => [index("inspections_project_id_idx").on(table.projectId)],
);
...
export const inspectionResponses = pgTable(
  ...
  (table) => [index("inspection_responses_inspection_id_idx").on(table.inspectionId)],
);
