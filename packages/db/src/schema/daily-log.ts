...
export const dailyLogManpower = pgTable(
  "daily_log_manpower",
  {
    id: idColumn(),
  ...
  (table) => [index("daily_log_manpower_daily_log_id_idx").on(table.dailyLogId)],
);

export const dailyLogEquipment = pgTable(
  "daily_log_equipment",
  {
    id: idColumn(),
    dailyLogId: uuid("daily_log_id")
  ...
  (table) => [index("daily_log_equipment_daily_log_id_idx").on(table.dailyLogId)],
);

export const dailyLogDeliveries = pgTable(
  ...
  (table) => [index("daily_log_deliveries_daily_log_id_idx").on(table.dailyLogId)],
);
 ...
 */
export const dailyLogSafetyIncidents = pgTable(
  "daily_log_safety_incidents",
  {
    id: idColumn(),
    dailyLogId: uuid("daily_log_id")
      .notNull()
  ...
  (table) => [index("daily_log_safety_incidents_daily_log_id_idx").on(table.dailyLogId)],
);
