...
export const documentFolders = pgTable(
  ...
  (table) => [index("document_folders_project_id_idx").on(table.projectId)],
);
...
export const documents = pgTable(
  ...
  (table) => [index("documents_project_id_idx").on(table.projectId), index("documents_folder_id_idx").on(table.folderId)],
);
...
export const drawings = pgTable(
  ...
  (table) => [index("drawings_project_id_idx").on(table.projectId)],
);
...
export const drawingRevisions = pgTable(
  ...
  (table) => [index("drawing_revisions_drawing_id_idx").on(table.drawingId)],
);
...
export const markups = pgTable(
  ...
  (table) => [index("markups_drawing_revision_id_idx").on(table.drawingRevisionId)],
);
