...
export const photoAlbums = pgTable(
  ...
  (table) => [index("photo_albums_project_id_idx").on(table.projectId)],
);
...
export const photos = pgTable(
  ...
  (table) => [index("photos_project_id_idx").on(table.projectId), index("photos_album_id_idx").on(table.albumId)],
);
