...
export function ProjectTabs({ projectId }: { projectId: string }) {
  ...
  const tabs = [
    ...
    { key: "prequalification", label: t("prequalification"), href: `/${locale}/projects/${projectId}/prequalification` },
    { key: "bidding", label: t("bidding"), href: `/${locale}/projects/${projectId}/bidding` },
    { key: "estimating", label: t("estimating"), href: `/${locale}/projects/${projectId}/estimating` },
    { key: "prime-contract", label: t("primeContract"), href: `/${locale}/projects/${projectId}/prime-contract` },
    { key: "budget", label: t("budget"), href: `/${locale}/projects/${projectId}/budget` },
    { key: "direct-costs", label: t("directCosts"), href: `/${locale}/projects/${projectId}/direct-costs` },
