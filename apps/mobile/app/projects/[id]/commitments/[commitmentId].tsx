...
const styles = StyleSheet.create({
  ...
  contractValueCard: { borderWidth: 3, borderColor: colors.ink, borderRadius: 12, backgroundColor: colors.orange50, padding: 16, marginBottom: 16 },
  ...
  lineCard: { borderWidth: 3, borderColor: colors.ink, borderRadius: 8, padding: 12, backgroundColor: colors.white, flexDirection: "row", justifyContent: "space-between", gap: 8 },
