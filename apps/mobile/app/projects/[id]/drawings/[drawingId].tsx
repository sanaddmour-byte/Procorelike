...
const styles = StyleSheet.create({
  ...
  offlineNote: { fontSize: 12, color: "#92400e", backgroundColor: "#fef3c7", padding: 10, borderRadius: 8, marginBottom: 8 },
  hint: { fontSize: 13, color: "#92400e" },
  button: { backgroundColor: "#0f172a", borderRadius: 8, paddingVertical: 12, alignItems: "center", marginBottom: 8 },
