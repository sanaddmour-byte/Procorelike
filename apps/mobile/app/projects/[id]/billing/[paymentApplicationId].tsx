...
const styles = StyleSheet.create({
  ...
  lineCard: { borderWidth: 1, borderColor: colors.ink, borderRadius: 8, shadowColor: colors.ink, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 6, elevation: 4, padding: 12, backgroundColor: colors.white, gap: 4 },
  ...
  totalCard: { borderWidth: 1, borderColor: colors.ink, borderRadius: 12, shadowColor: colors.ink, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 6, elevation: 4, backgroundColor: colors.orange50, padding: 16, marginTop: 8 },
