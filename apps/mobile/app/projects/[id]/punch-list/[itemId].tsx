...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 13, color: "#334155", marginTop: 12 },
  value: { fontSize: 16, fontWeight: "600" },
  input: { borderWidth: 1, borderColor: "#cbd5e1", borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 15 },
  textArea: { minHeight: 100, textAlignVertical: "top" },
  conflictBanner: { backgroundColor: "#fee2e2", borderRadius: 8, padding: 12, gap: 4, marginBottom: 8 },
  conflictTitle: { color: "#991b1b", fontWeight: "700" },
  conflictLine: { color: "#7f1d1d", fontSize: 12 },
  hint: { fontSize: 12, color: "#92400e", marginTop: 12 },
  error: { fontSize: 12, color: "#dc2626", marginTop: 8 },
  transitionRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 16 },
  transitionButton: { backgroundColor: "#0f172a", borderRadius: 8, paddingHorizontal: 14, paddingVertical: 10 },
  buttonDisabled: { opacity: 0.6 },
  transitionButtonText: { color: "#fff", fontSize: 13, fontWeight: "600" },
});
