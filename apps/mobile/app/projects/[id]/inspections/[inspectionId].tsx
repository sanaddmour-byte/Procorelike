...
const styles = StyleSheet.create({
  ...
  status: { fontSize: 13, fontWeight: "600", color: "#334155" },
  offlineNote: { fontSize: 11, color: "#92400e", backgroundColor: "#fef3c7", padding: 10, borderRadius: 8, marginVertical: 6 },
  sectionTitle: { fontSize: 16, fontWeight: "600", marginTop: 8, marginBottom: 4 },
  card: { borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 8, padding: 12, gap: 8, marginBottom: 8 },
  prompt: { fontSize: 14, fontWeight: "500", color: "#0f172a" },
  row: { flexDirection: "row", gap: 8 },
  choice: { borderWidth: 1, borderColor: "#cbd5e1", borderRadius: 6, paddingHorizontal: 14, paddingVertical: 8, alignSelf: "flex-start" },
  choicePass: { backgroundColor: "#059669", borderColor: "#059669" },
  choiceFail: { backgroundColor: "#dc2626", borderColor: "#dc2626" },
  choiceActive: { backgroundColor: "#0f172a", borderColor: "#0f172a" },
  choiceText: { fontSize: 13, color: "#334155" },
  choiceTextActive: { fontSize: 13, color: "#fff", fontWeight: "600" },
  input: { borderWidth: 1, borderColor: "#cbd5e1", borderRadius: 6, paddingHorizontal: 10, paddingVertical: 8, fontSize: 14 },
  unsupported: { fontSize: 12, color: "#92400e" },
  signOffCard: { borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 8, padding: 12, gap: 8, marginTop: 8, marginBottom: 16 },
  label: { fontSize: 13, color: "#334155" },
  completeButton: { backgroundColor: "#0f172a", borderRadius: 8, paddingVertical: 12, alignItems: "center" },
  buttonDisabled: { opacity: 0.6 },
  completeButtonText: { color: "#fff", fontSize: 14, fontWeight: "600" },
  signedOff: { fontSize: 13, color: "#334155", marginTop: 8, marginBottom: 24 },
});
