...
const styles = StyleSheet.create({
  ...
  card: { borderWidth: 1, borderColor: "#171310", borderRadius: 8, backgroundColor: "#ffffff", shadowColor: "#171310", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 6, elevation: 4, padding: 12, gap: 8, marginBottom: 8 },
  prompt: { fontSize: 14, fontWeight: "500", fontFamily: "Poppins_500Medium", color: "#080f1c" },
  row: { flexDirection: "row", gap: 8 },
  choice: { borderWidth: 1, borderColor: "#171310", borderRadius: 6, paddingHorizontal: 14, paddingVertical: 8, alignSelf: "flex-start" },
  ...
  input: { borderWidth: 1, borderColor: "#171310", borderRadius: 6, paddingHorizontal: 10, paddingVertical: 8, fontSize: 14 },
  unsupported: { fontSize: 12, color: "#9a3412" },
  signOffCard: { borderWidth: 1, borderColor: "#171310", borderRadius: 8, backgroundColor: "#ffffff", shadowColor: "#171310", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 6, elevation: 4, padding: 12, gap: 8, marginTop: 8, marginBottom: 16 },
