...
const styles = StyleSheet.create({
  ...
  card: { borderWidth: 3, borderColor: colors.ink, borderRadius: 12, backgroundColor: colors.white, padding: 16, marginBottom: 16, gap: 2 },
  ...
  list: { gap: 8 },
  approvalCard: { borderWidth: 3, borderColor: colors.ink, borderRadius: 8, padding: 12, backgroundColor: colors.white },
